...
module generate_board_counts_temp_core (q, ra, ce, reset, clk
, d, wa, we);
    parameter READ_PORT_COUNT=32'd2;
    parameter WRITE_PORT_COUNT=32'd1;
    parameter DATA_WIDTH=32'd32;
    parameter ADDRESS_WIDTH=32'd3;
    parameter WORD_COUNT=32'd8;
...
module generate_board_counts_temp (
    address0,
    ce0,
    q0,
    we0,
...
generate_board_counts_temp_core #(
    .READ_PORT_COUNT( 2 ),
    .WRITE_PORT_COUNT( 1 ),
