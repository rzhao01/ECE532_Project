...
`timescale 1 ns / 1 ps
module generate_board_counts_grp_busburstwrite_fu_138_504 (clk, reset, bus_req_din, bus_req_full_n,  bus_req_write, bus_rsp_empty_n, bus_rsp_read,  bus_address, bus_size, bus_addressin, mem_addressin, bus_datain,  bus_dataout, mem_address0, mem_ce0, mem_we0, mem_d0, mem_q0, sizein, command, start, done);
