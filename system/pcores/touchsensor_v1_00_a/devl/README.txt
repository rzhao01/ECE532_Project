...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\Xilinx\14.2\ISE_DS\edk_user_repository\MyProcessorIPLib
  logical library name                       : touchsensor_v1_00_a
  top name                                   : touchsensor
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
Address Block for User Logic and IPIF Predefined Services
  ...
  user logic slave space                     : C_BASEADDR
                                             : C_BASEADDR
  software reset space                       : C_BASEADDR + 0x00000000
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/touchsensor_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/touchsensor_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\Xilinx\IP_Project1\IP2_Test\C:\Xilinx\14.2\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
