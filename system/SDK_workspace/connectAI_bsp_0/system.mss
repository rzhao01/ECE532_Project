...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = tft_perhipheral
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = tft_perhipheral_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = touchsensor
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = touchsensor_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = generate_board_counts_top_0
END
